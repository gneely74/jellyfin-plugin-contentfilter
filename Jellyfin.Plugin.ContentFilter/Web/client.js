    ...
    function ensureEditorModal() {
        ...
        if (!editorModal) {
            ...
            editorModal.innerHTML = [
                ...
                '          <option value="SexAndNudity.PartialNudity">SexAndNudity.PartialNudity (Lingerie, Swimwear)</option>',
                ...
                '          <option value="SexualReferences.ContextualDialogue">SexualReferences.ContextualDialogue (Innuendo)</option>',
                '        </optgroup>',
                '        <optgroup label="Violence & Gore">',
                ...
                '          <option value="Language.GeneralProfanity">Language.GeneralProfanity (Swear Words)</option>',
                '          <option value="Language.Blasphemy">Language.Blasphemy (Religious Oaths)</option>',
                '          <option value="Language.RacialAndBigotedSlurs">Language.RacialAndBigotedSlurs</option>',
                '          <option value="SexualReferences.ExplicitWords">SexualReferences.ExplicitWords (Crude Slang)</option>',
                '          <option value="Language.ChildishLanguage">Language.ChildishLanguage (Bathroom Humor)</option>',
                '        </optgroup>',
                '        <optgroup label="Alcohol, Drugs & Smoking">',
                ...
                '        </optgroup>',
                '        <optgroup label="Frightening & Intense Scenes">',
                '          <option value="Violence.Disturbing">Violence.Disturbing (Corpses, Psychological)</option>',
                '          <option value="Violence.JumpScares">Violence.JumpScares (Startle)</option>',
                '        </optgroup>',
                '        <optgroup label="Other / Playback & Medical">',
